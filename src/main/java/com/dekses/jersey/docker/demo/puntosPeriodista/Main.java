...
public class Main {
    ...
    public static HttpServer startServer() {
        ...
        final ResourceConfig rc = new ResourceConfig().packages("com.dekses.jersey.docker.demo.puntosPeriodista");
    ...
    public static void main(String[] args) throws IOException {
       ...
       Client client = Client.create();
        ...
        webResource = client.resource("http://localhost:8080/myapp/fakenewspuntosper");
        ...
        try {
            ...
            PuntosPeriodista pun = new PuntosPeriodista();
            ...
            do {
                ...
                switch (opcion) {
                    ...
                    case 1: // Mostrar Todos
                        ...
                        List Listapuntos = PuntosPeriodistaDAO.getAllPuntosperiodista();

                        for (int i = 0; i < Listapuntos.size(); i++) {
                            pun = (PuntosPeriodista) Listapuntos.get(i);
                    ...
                    case 2: // Crear
                        ...
                        PuntosPeriodistaDAO.addPuntosperiodista(pun);
                    ...
                    case 3: // Buscar.
                        ...
                        PuntosPeriodista puntosRetorno = PuntosPeriodistaDAO.getpuntosperiodista(id);
                    ...
                    case 4: // Modificar.
                        ...
                        PuntosPeriodistaDAO.updatePuntosperiodista(pun, idEmail);
                        System.out.println("Listo! c: ");
